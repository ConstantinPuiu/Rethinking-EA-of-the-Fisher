...
# original code (and credit for this file goes to): https://github.com/ikostrikov/pytorch-a2c-ppo-acktr-gail/blob/master/a2c_ppo_acktr/algo/kfac.py
# Modified by me to fit our purpose!
...
class KFACOptimizer(optimLib.Optimizer):
    def __init__(self,
                 model,
    ...
    def _save_input(self, module, input):
        if self.model.training and self.steps % self.Ts == 0: # input[0].volatile == False 
    ...
    def step(self, epoch_number, error_savepath):
        ...
        if self.kl_clip >= 1e10: # if we set the clip threshold rly high, just don't clip!
            ...
            #if nu < 1: print('KFAC STANDARD CLIP ACTIVATED!')
